...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/backpackercoin/backpackercoin>";
    const std::string URL_WEBSITE = "<https://backpackercoin.com>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Backpackercoin version %s\n", FormatFullVersion());
}
