...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s backpackercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  backpackercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded backpackercoin transaction") + "\n" +
              "  backpackercoin-tx [options] -create [commands]   " + _("Create hex-encoded backpackercoin transaction") + "\n" +
              "\n";
