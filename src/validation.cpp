...
#if defined(NDEBUG)
# error "Backpackercoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Backpackercoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BPC additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if(nHeight < 1000)
    {
       nSubsidy = 1022948.68 * COIN; //premine 1022948680 BPC in 1k blocks
    }
    else if(nHeight < 15344230)
    {
       nSubsidy = 100 * COIN; // rest 1534423000 BPC in next 15344230 blocks
    }    
